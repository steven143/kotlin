...
enum class LanguageFeature(
    ...
    enum class Kind(val enabledInProgressiveMode: Boolean, val forcesPreReleaseBinaries: Boolean) {
         ...
         *
         * For BUG_FIX, [enabledInProgressiveMode] == true and [forcesPreReleaseBinaries] == false
         */
        BUG_FIX(true, false),
         ...
         *
         * For UNSTABLE_FEATURE, [enabledInProgressiveMode] == false and [forcesPreReleaseBinaries] == true
         */
         ...
         *
         * For OTHER, [enabledInProgressiveMode] == false and [forcesPreReleaseBinaries] == *false*
         *
