...
class KotlinGradleMultiplatformModuleBuilder : GradleModuleBuilder() {
    ...
    override fun setupRootModel(modifiableRootModel: ModifiableRootModel) {
        ...
        if (commonModuleName.isNullOrEmpty()) {
            ...
            GradleKotlinMPPCommonFrameworkSupportProvider().addSupport(buildScriptData, module, sdk)
        }
    }
    ...
    private fun setupCommonModule(
        ...
        GradleKotlinMPPCommonFrameworkSupportProvider().addSupport(builder, rootModule, sdk)
    }
    ...
    private fun setupPlatformModule(
        ...
        supportProvider.addSupport(builder, rootModule, finalSdk)
